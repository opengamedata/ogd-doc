...
The :doc:`first chapter <welcome/index>` presents a summary of the project and overall organization of the documentation site.
The second chapter covers :doc:`getting started <getting_started/index>` in OpenGameData.
